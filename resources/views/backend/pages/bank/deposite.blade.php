...
@section('page_action')
    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
            ...
            <li class="breadcrumb-item">Deposite</li>
        </ol>
    </nav>
@endsection
@section('content')
    ...
    @include('backend.layouts.error_msg')
        <div class="block block-rounded block-content col-sm-6 ">
            <div class="block-header">
                <h3 class="block-title">Deposit Amount</h3>
            </div>

            <form class="js-validation" action="{{ url('bank/updateOnDeposit') }}" method="POST" id="form">
                @csrf
                @method('patch')
                    ...
                    <div class="block-content pb-6">
                        <div class="row items-push">
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="amount" name="amount" min="50" placeholder="Min Amount 50.." required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row items-push">
                            <div class="col-lg-6 offset-lg-5">
                                <button type="submit" class="btn btn-alt-primary" id="submit">Deposit</button>
                            </div>
                        </div>
                        <!-- END Deposit -->
                    </div>
